...
<head>
    ...
    <link href="estado_recursos.css" rel="stylesheet">
</head>
<body>
<div class="d-flex">
    <!-- Sidebar -->
            ...
            <li class="nav-item">
                ...
                <div class="collapse show" id="adminSubmenu">
                    <ul class="nav flex-column ms-3">
                        ...
                        <li class="nav-item"><a href="../../../../paginas/recursos/estado-recursos/estado-recursos.php" class="nav-link active text-white"><i class="fas fa-chart-line me-2"></i>Estado de Recursos</a></li>
